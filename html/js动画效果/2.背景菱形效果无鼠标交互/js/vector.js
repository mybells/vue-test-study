...
(function () {
  ...
  if (!window.requestAnimationFrame) window.requestAnimationFrame = function (b) { var c = (new Date).getTime(),
      f = Math.max(0, 16 - (c - a)),
...
CAV.Vector4 = {
  create: function (a, b, c) { var d = new CAV.Array(4);
    this.set(d, a, b, c); return d },
...
CAV.Triangle.prototype = {
  computeCentroid: function () { this.centroid[0] = this.a.position[0] + this.b.position[0] + this.c.position[0];
    ...
    CAV.Vector3.divideScalar(this.centroid, 3); return this },
